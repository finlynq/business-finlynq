...
export const INBOX_MCP_TOOLS = [
  ...
  defineMcpTool({ policy: { name: "finlynq_daily_list_document_storage", group: "DAILY", access: "READ", permissionsAny: read },
    title: "List connected document inboxes", description: "List authorized company/module cloud inboxes, connection status, and last sync. Connect or reconnect Google Drive/OneDrive in the secure Document storage settings. No credentials are returned.",
