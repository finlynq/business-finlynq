...
export const DAILY_MCP_TOOLS: readonly McpToolDefinition[] = [
  ...
  createDocumentTool({ name: "finlynq_daily_create_sales_invoice", title: "Create sales invoice draft", description: "Create an idempotent sales-invoice draft with explicit customer, control, revenue, tax, dates, currency, FX evidence, and exact line amounts.", kind: "SALES_INVOICE", permission: PERMISSIONS.manageReceivables }),
  editDocumentTool({ name: "finlynq_daily_edit_sales_invoice", title: "Edit sales invoice draft", description: "Create a new immutable version of an existing sales-invoice draft. The exact current version is required.", kind: "SALES_INVOICE", permission: PERMISSIONS.manageReceivables }),
  ...
  createDocumentTool({ name: "finlynq_daily_create_supplier_bill", title: "Create supplier bill draft", description: "Create an idempotent supplier-bill draft with explicit supplier, AP control, expense, tax, dates, currency, FX evidence, and exact line amounts.", kind: "SUPPLIER_BILL", permission: PERMISSIONS.managePayables }),
  editDocumentTool({ name: "finlynq_daily_edit_supplier_bill", title: "Edit supplier bill draft", description: "Create a new immutable version of an existing supplier-bill draft. The exact current version is required.", kind: "SUPPLIER_BILL", permission: PERMISSIONS.managePayables }),
