...
export default async function JournalsPage({ searchParams }: { searchParams: Promise<{ q?: string }> }) {
  ...
  return (
    <div className="page-content">
      <PageHeader eyebrow="General ledger" title="Journals" description="Posted journals are immutable; correction ownership follows the source module." actions={<Link className="primary-button" href="/app/journals/new">＋ New journal</Link>} />
