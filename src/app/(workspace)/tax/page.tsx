  ...
  return (
    <div className="page-content">
      ...
      {principal.sessionMode === "demo" && (
        <DemoNotice>
          This list reflects your isolated writable sandbox. Transaction and tax changes are private to this session and the seeded business is restored automatically after use and reconciled nightly.
        </DemoNotice>
      )}
