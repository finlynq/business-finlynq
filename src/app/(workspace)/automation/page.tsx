...
export default function AutomationPage() {
  return (
    <div className="page-content">
      ...
      <DemoNotice>No public MCP endpoint or OAuth service principal is active in this deployment. The scopes below are the approved v0 contract, not a live connection.</DemoNotice>
