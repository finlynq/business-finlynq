  ...
  return (
    <div className="settings-layout">
      ...
      <section className="panel" aria-labelledby="mcp-connections-title">
        ...
        <p className="panel-note">Off removes the group from the client. Read only exposes queries and reports. Ask before writes creates a one-time approval. Allow writes still enforces your role, accounting workflow, maker-checker rules, period controls, and organization write state. Setup changes and reconciliation control transitions always require an MFA-backed one-time approval.</p>
      </section>
    </div>
  );
}
