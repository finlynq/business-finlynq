...
export default function PrivacyPage() {
  return (
    <LegalPage eyebrow="Privacy" title="A demo designed for synthetic data." intro="Last updated August 27, 2026. This notice covers the public Business Finlynq website and hosted demo.">
      ...
      <section><h2>Public demo</h2><p>Each temporary demo session leases a synthetic sandbox isolated from other visitors. It is not a confidential or durable customer workspace: do not enter personal, financial, confidential, or customer information, and expect all sandbox changes and sessions to be reset.</p></section>
