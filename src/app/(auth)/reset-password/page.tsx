...
export default function ResetPasswordPage() {
  ...
  return (
    <AuthShell
      ...
      description={accountLoginEnabled ? "Changing your password revokes existing sessions but does not alter your organization’s encrypted accounting records." : "Only the fixed synthetic demo identity can access this hosted release."}
    >
