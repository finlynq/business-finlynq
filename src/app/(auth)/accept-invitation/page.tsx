...
export default function AcceptInvitationPage() {
  ...
  return (
    <AuthShell eyebrow="Account invitation" title={enabled ? "Secure your account" : "Invitations are not enabled in the preview"}
      description={enabled ? "Create a password and enroll a TOTP authenticator. Your account remains disabled until both steps finish." : "Only the fixed synthetic demo identity can access this hosted release."}>
