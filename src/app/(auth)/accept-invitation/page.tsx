...
export default function AcceptInvitationPage() {
  ...
  return (
    <AuthShell eyebrow="Account invitation" title={enabled ? "Secure your account" : "Invitations are not enabled in the preview"}
      description={enabled ? "Create a password, then scan an authenticator QR code for stronger security or continue with password-only sign-in." : "Real account invitations are disabled. The shared public demo opens without registration."}>
