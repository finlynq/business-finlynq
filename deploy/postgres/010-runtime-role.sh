...
BEGIN
  ...
  FOREACH selected_name IN ARRAY ARRAY[
    ...
    'mcp_oauth_clients', 'mcp_connections',
  ...
  FOREACH selected_name IN ARRAY ARRAY[
    ...
    'tax_account_mapping_lines', 'tax_filings', 'tax_filing_configurations',
    'tax_filing_lifecycle_events', 'tax_filing_canonical_selections',
